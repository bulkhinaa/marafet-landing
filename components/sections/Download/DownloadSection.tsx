      ...
      <Container size="lg" className="relative">
        ...
        >
          <span className="inline-flex w-fit items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-white ring-1 ring-inset ring-white/20 backdrop-blur">
            <Heart className="h-3.5 w-3.5 fill-rose-50 text-rose-50" />
            Скачать приложение
          </span>
          ...
          <p className="max-w-xl text-pretty text-base leading-relaxed text-white/75 md:text-lg">
            Бесплатно. Без подписок. Бонусы за каждого приглашённого друга и
            даже за его друзей.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            >
              <svg className="h-8 w-8" viewBox="0 0 24 24" aria-hidden>
                <defs>
                  <linearGradient id="gp-dl-1" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#00d4ff" />
                    <stop offset="100%" stopColor="#0078ff" />
                  </linearGradient>
                  <linearGradient id="gp-dl-2" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#ff9500" />
                    <stop offset="100%" stopColor="#ffd400" />
                  </linearGradient>
                  <linearGradient id="gp-dl-3" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#ff3a3a" />
                    <stop offset="100%" stopColor="#ff7676" />
                  </linearGradient>
                  <linearGradient id="gp-dl-4" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            {/* QR placeholder */}
            <div className="hidden items-center gap-3 rounded-2xl bg-white/[0.04] px-4 py-3 ring-1 ring-inset ring-white/15 backdrop-blur-sm md:flex">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white">
                <QrCode className="h-7 w-7 text-ink-100" strokeWidth={1.5} />
              </div>
